...
<html lang="en">
  <head>
    ...
    <title>सिंधुदुर्ग तक्रार निवारण प्रणाली | वापरकर्ता संकेतशब्द बदला</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> प्रोफाइल माहिती</h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <b>छान !</b> <?php echo htmlentities($successmsg);?></div>
                      <?php }?>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <b>अरे स्नॅप!</b> </b> <?php echo htmlentities($errormsg);?></div>
                      <?php }?>
 ...
 ?>                     
  ...
  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fullName']);?>'चे प्रोफाइल</h4>
    <h5><b>रोजी अखेरचे अद्यतनित :</b>&nbsp;&nbsp;<?php echo htmlentities($row['updationDate']);?></h5>
                      <form class="form-horizontal style-form" method="post" name="profile" >

<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">पूर्ण नाव</label>
<div class="col-sm-4">
<input type="text" name="fullname" required="required" value="<?php echo htmlentities($row['fullName']);?>" class="form-control" >
 </div>
<label class="col-sm-2 col-sm-2 control-label">वापरकर्ता ईमेल </label>
 <div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">संपर्क</label>
 <div class="col-sm-4">
<input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['contactNo']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">पत्ता </label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">राज्य</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">देश </label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">पिन कोड</label>
<div class="col-sm-4">
<input type="text" name="pincode" maxlength="6" required="required" value="<?php echo htmlentities($row['pincode']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">नोंदणी तारीख </label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">वापरकर्ता फोटो</label>
<div class="col-sm-4">
<?php $userphoto=$row['userImage'];
if($userphoto==""):
?>
<img src="userimages/noimage.png" width="256" height="256" >
<a href="update-image.php">फोटो बदला</a>
<?php else:?>
...
<button type="submit" name="submit" class="btn btn-primary">प्रस्तुत करणे</button>
</div>
</div>
