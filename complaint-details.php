...
<a href="javascript:void(0);" onClick="popUpWindow('updatecomplaintsms.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Reply By SMS</button>
											</a><?php } ?>
											
											<?php if($row['status']=="closed"){

												} else {?>
<a href="javascript:void(0);" onClick="popUpWindow('updatecomplaintemail.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Reply By Mail</button>
											</a><?php } ?>
