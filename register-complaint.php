...
<html lang="en">
  <head>
    ...
    <title>सिंधुदुर्ग तक्रार व्यवस्थापन प्रणाली | वापरकर्ता नोंदणी तक्रार</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> तक्रार नोंदवा</h3>
...
<label class="col-sm-2 col-sm-2 control-label">विभाग</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">उप श्रेणी </label>
 <div class="col-sm-4">
<select name="subcategory" id="subcategory" class="form-control" >
<option value="">उपश्रेणी निवडा</option>
</select>
</div>
 </div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">तक्रार प्रकार</label>
<div class="col-sm-4">
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> तक्रार </option>
                  <option value="General Query">सामान्य प्रश्न</option>
                </select> 
</div>

<label class="col-sm-2 col-sm-2 control-label">तालुका</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">तक्रारीचे स्वरूप</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">तक्रार तपशील (जास्तीत जास्त 2000 शब्द) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">तक्रार संबंधित कागदपत्र (असल्यास) </label>
<div class="col-sm-6">
