...
if(isset($_POST['update'])){
   ...
   //$numbers='91'.$_POST['c_no'];
   // $message='hello';
    $apiKey = urlencode('dhBXF2btvRg-35lYLFTGLBwm5q9DVdOZQVWpG5VWjn');

	// Message details
	$numbers = array(917021956142);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <option value="closed">Closed</option>
     ...
     <tr height="50">
      ...
      <td><input type='text' name="c_no" value="<?php echo $row['contactNo']?>" required="required" readonly>
      </td>
    </tr>
