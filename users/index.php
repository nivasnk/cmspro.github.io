...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff">सिंधुदुर्ग तक्रार निवारण प्रणाली</a></h3>
	<hr />
		      <form class="form-login" name="login" method="post">
		        <h2 class="form-login-heading">आता साइन इन करा</h2>
		        ...
		        <div class="login-wrap">
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a data-toggle="modal" href="login.html#myModal"> संकेतशब्द विसरलात?</a>
		
		                </span>
		            </label>
		            <button class="btn btn-theme btn-block" name="submit" type="submit"><i class="fa fa-lock"></i> साइन इन करा</button>
		            <hr>
		           </form>
