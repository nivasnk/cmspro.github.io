...
<?php endif;?>
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>खाते व्यवस्थापन</span>
                      </a>
                      <ul class="sub">
                          <li><a  href="profile.php">प्रोफाइल</a></li>
                          <li><a  href="change-password.php">संकेतशब्द बदला</a></li>
